...
echo.
REM python 10_test_mlp.py facilities --facility_config 200_50_3 --model_path trained_models/facilities/baseline_torch --start_file 0 --end_file 10000
...
python 10_test_gcnn_torch.py facilities -g -1 --config 200_50_3 --model_name baseline_torch --max_samples 10000
if %ERRORLEVEL% neq 0 (
...
FOR %%M IN (
    ...
    python 10_test_hybrid.py facilities --config 200_50_3 --model_name %%~M  --max_samples 10000
    if %ERRORLEVEL% neq 0 (
